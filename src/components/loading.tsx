...
const Loading = () => {
  return (
    <div
  className="max-w-full p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-400"
>
<div className="flex items-center mb-4">
    ...
    <div>
    <div className="w-48 h-2 bg-gray-200 rounded-full dark:bg-gray-400 mb-2"></div>
      <div
        className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-400 w-32 "
      ></div>
